...
## Summary of Results
```{r, echo=FALSE}
##>>>ST:Value(Label="Population size", Frequency="On Demand", Type="Default")
population_size <- nrow(patient_cohort)
##<<<
##>>>ST:Value(Label="Number of cases", Frequency="On Demand", Type="Default")
num_cases <- nrow(patient_cohort[patient_cohort$case_control == 'Case',])
##<<<
##>>>ST:Value(Label="Number of controls", Frequency="On Demand", Type="Default")
...
##>>>ST:Table(Label="Participant characteristics", Frequency="On Demand", Label="Participant characteristics", Frequency="On Demand", Type="Numeric", AllowInvalid=True, Decimals=0, Thousands=False)
knitr::kable(Table1)
##<<<
```
...
```{r, echo=FALSE, comment=NA, size = 'tiny'}
##>>>ST:Figure(Label="Encounter distribution", Frequency="On Demand")
...
##>>>ST:Verbatim(Label="R Version", Frequency="On Demand")
